...
function desktopOnly(testInfo: TestInfo) {
  test.skip(testInfo.project.name !== "chromium", "Admin overview checks run once on desktop Chromium.");
}
...
for (const [role, email] of [
  ...
  test(`${role} sees the administration overview and attention links`, async ({ page }, testInfo) => {
