...
export type AuditCategory = "parent-access" | "leader-request" | "leader-access" | "member" | "event" | "event-consent" | "equipment" | "system";
...
const AUDIT_CATEGORIES = ["parent-access", "leader-request", "leader-access", "member", "event", "event-consent", "equipment", "system"] as const;
