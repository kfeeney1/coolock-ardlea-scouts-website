...
import { createWeeklyMeeting, defaultActivityPlans, defaultBadgeworkPlans, loadWeeklyAccess, loadWeeklyMeetings, newActivityPlan, newBadgeworkPlan, updateWeeklyMeeting } from "../services/weeklyTracker";
import type { InjurySeverity, WeeklyAccess, WeeklyActivityPlan, WeeklyBadgeworkPlan, WeeklyInjury, WeeklyMeetingRecord } from "../services/weeklyTracker";
...
export default function WeeklySectionTracker() {
  ...
  const refresh=async(known?:WeeklyAccess)=>{
    ...
    try {
      ...
      setMembers(m.filter(x=>x.status==="active")); setRecords(r);
