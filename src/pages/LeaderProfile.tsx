...
export default function LeaderProfile() {
    ...
    useEffect(() => {
        const load = async () => {
            ...
            try {
                ...
                console.error(
                    "Unable to load leader profile:",
                    error
                );

                setProfileError(
                    "Unable to load your leader profile."
                );
            } finally {
                setLoading(false);
            }
    ...
    const saveProfile = async () => {
        ...
        try {
            ...
            setProfileMessage(
                "Your leader details have been updated."
            );
        } catch (error) {
            console.error(
                "Unable to update leader profile:",
                error
            );
    ...
    const changePassword = async () => {
        ...
        try {
            ...
            console.error(
                "Unable to change leader password:",
                error
            );
                    ...
                    >
                        ...
                        >
                            ...
                            <TextField
                                ...
                                disabled
                                helperText="Only an administrator can change access roles."
                                sx={{
                                    gridColumn: {
                                        sm: "1 / -1"
                                    }
