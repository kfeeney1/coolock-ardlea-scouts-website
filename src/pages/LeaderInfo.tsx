...
const faqs = [
  ...
  { q: "How does event consent work?", a: "For an open event that requires consent, leaders can open Manage Consent directly from that event. Parents use the tokenised consent flow, while authorised leaders can review and match responses and see consent state in the event roster." },
  ...
  { q: "What happens when an event is completed?", a: "Events move deliberately through Draft, Open, Closed and Completed. Completion requires a resolved attendance roster and, when consent is required, no outstanding consent for members still attending. Completed events remain read-only history for reporting and review." },
  { q: "How do weekly meetings work?", a: "Weekly Meetings starts with Create Meeting, Open Meeting and Meeting History. Future meetings open into Programme for planning. A meeting can be saved without leaving the editor, closed when finished, and later reopened by an authorised leader if corrections are needed." },
  ...
  { q: "What is the Programme Library?", a: "Leaders can save reusable activity/game and badgework rows to the section-scoped Programme Library and insert them into another Weekly Meeting. Each insertion creates a fresh meeting item; attendance, incidents, completed badgework and post-meeting notes are never carried across." },
  ...
  { q: "Where can I see attendance trends?", a: "Attendance Insights provides separate Weekly Meeting, Event and Combined recorded-attendance rates, recent attendance across both sources, inclusive date-range filtering and per-member detail. Unrecorded attendance is excluded from the rate denominator." },
  { q: "What reports are available?", a: "Reports & Exports includes member lists, membership summaries, date-filtered event overviews, attendance-trend exports, event attendance/consent rosters, outstanding-consent reporting and a print-friendly operational summary, all limited to the leader’s permitted scope." },
  ...
  { q: "Who can see the Activity Log?", a: "The Activity Log is read-only and available to Admin, Super Admin, Group Leader and Group Secretary roles. It records important administrative and leader actions, including Weekly Meeting create, update, close, reopen and copy actions. Entries cannot be edited or deleted from the website." },
    ...
    <Box sx={{ minHeight: "100vh", backgroundColor: "background.default", py: { xs: 4, md: 6 } }}>
      <Container maxWidth="xl">
        ...
        <Alert severity="success" sx={{ mb: 3 }}>
          Stages 1–10 are complete. The portal is now in ongoing maintenance and continuous improvement; future changes should preserve the security, data-integrity, accessibility, recovery, seed-stability and Firestore read-efficiency safeguards already established.
        </Alert>
