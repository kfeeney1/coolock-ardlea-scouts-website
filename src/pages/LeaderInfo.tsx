...
const faqs = [
  ...
  { q: "Where can I see attendance trends?", a: "Attendance Insights provides searchable reporting based on recorded attendance, with meeting/event filtering and per-member attendance detail. Weekly Meeting History remains the place to inspect an individual meeting." },
  { q: "What reports are available?", a: "Reports & Exports includes member lists, membership summaries, event attendance/consent exports, event overviews and outstanding-consent reporting, limited to the leader’s permitted scope." },
    ...
    <Box sx={{ minHeight: "100vh", backgroundColor: "background.default", py: { xs: 4, md: 6 } }}>
      <Container maxWidth="xl">
        ...
        <Alert severity="success" sx={{ mb: 3 }}>
          Stages 1–9 are complete. The portal is now in ongoing maintenance and continuous improvement; future changes should preserve the security, data-integrity, accessibility, recovery and regression safeguards already established.
        </Alert>
