...
const faqs = [
  ...
  { q: "Why might I see fewer menu options than another leader?", a: "The Leader Portal is permission-aware. Available pages and actions depend on approved access level, assigned sections and Scouting role." },
  ...
  { q: "How is accessibility checked?", a: "Playwright includes accessibility and mobile regression coverage across representative public, parent and leader routes, including semantic structure, named controls, keyboard focus and horizontal-overflow checks." },
    ...
    <Box sx={{ minHeight: "100vh", backgroundColor: "background.default", py: { xs: 4, md: 6 } }}>
      <Container maxWidth="xl">
        ...
        <Alert severity="success" sx={{ mb: 3 }}>
          Stages 1–16 are complete. The portal now includes Adventure Skills, Equipment & Stores, Section Floats with secure receipts and consent-aware Event Galleries alongside the established member, meeting, event, parent and reporting workflows. Future development should preserve the security, privacy, data-integrity, accessibility, recovery, seed-stability and Firestore/Storage efficiency safeguards already established.
        </Alert>
