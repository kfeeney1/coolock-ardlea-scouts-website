...
- Dashboard submission records are cached for 90 seconds to avoid immediately re-reading up to 200 join applications and 200 consent submissions after route remounts. Status writes invalidate that cache.
