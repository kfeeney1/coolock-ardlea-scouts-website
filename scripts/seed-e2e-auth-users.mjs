...
async function seed() {
  ...
  console.log("Public E2E roles use Programme Scouter titles; a deliberately stale public Admin record proves the client never renders privileged identities.");
}
