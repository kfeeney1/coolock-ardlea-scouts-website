...
const users = [
  ...
  { uid: "TEST_uid_leader_only_01", email: "test.leader.only@example.com", displayName: "Aisling Ryan", kind: "leader", admin: { role: "leader", sections: ["Scouts"], scoutingRole: "Scout Programme Scouter", organisationSection: "Scouts", organisationOrder: 10, reportsToUid: WEB_ADMIN_UID, showPublicly: true } },
  { uid: "TEST_uid_multi_section_leader_01", email: "test.leader.multisection@example.com", displayName: "Conor Walsh", kind: "multi-section-leader", admin: { role: "leader", sections: ["Beavers", "Cubs"], scoutingRole: "Assistant Section Leader", organisationSection: "Cubs", organisationOrder: 20, reportsToUid: WEB_ADMIN_UID, showPublicly: true } },
  { uid: WEB_ADMIN_UID, email: "test.webadmin@example.com", displayName: "Test Website Administrator", kind: "admin", admin: { role: "admin", sections: ["Group"], scoutingRole: "Group Leader", organisationSection: "Group", organisationOrder: 1, reportsToUid: "", showPublicly: false } },
  { uid: "TEST_uid_super_admin_01", email: "test.superadmin@example.com", displayName: "Test Super Admin", kind: "super-admin", admin: { role: "super-admin", sections: ["Group"], scoutingRole: "Group Council Administrator", organisationSection: "Group", organisationOrder: 20, reportsToUid: WEB_ADMIN_UID, showPublicly: false } },
  { uid: "TEST_uid_shared_super_admin_01", email: "superadmin@example.com", displayName: "Shared Tester Super Admin", kind: "shared-super-admin", password: "password1", admin: { role: "super-admin", sections: ["Group"], scoutingRole: "Group Council Administrator", organisationSection: "Group", organisationOrder: 30, reportsToUid: WEB_ADMIN_UID, showPublicly: false } },
