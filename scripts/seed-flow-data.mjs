...
const events = [
  ...
  ["TEST_flow_event_public_single_day", { title: "TEST Public Single Day Activity", description: "Canonical public single-day example with no separate end date.", eventType: "Activity", section: "Scouts", location: "Scout Den", meetingPoint: "Scout Den", returnDetails: "Scout Den", leaderNotes: "TEST DATA", startDate: relativeDate(21), endDate: "", status: "open", consentRequired: false, attendance: {}, consent: {}, createdAt: now, createdBy: "TEST_SEED", updatedBy: "TEST_SEED" }],
...
function canonicalYouthConsent(memberRecord, medical) {
  return {
    ...
    medicationManagement: medical ? {
      enabled: true,
      memberName: memberRecord.displayName,
      dateOfBirth: memberRecord.dateOfBirth,
      address: "Test Address",
      medicineName: "Synthetic test medicine",
      dosage: "Synthetic test dose",
      frequency: "Once daily - TEST DATA",
      quantitySupplied: "7 - TEST DATA",
      doctorName: "Test GP",
      doctorTel: "012345678",
      pharmacyName: "Test Pharmacy",
      pharmacyTel: "012345679",
      method: "Synthetic test administration instructions",
      otherInfo: "Synthetic medication information for automated testing only.",
      selfAdmin: "No",
      authFrom: flowDates.consentFrom,
      authTo: flowDates.consentTo,
      scouter1: "Test Scouter One",
      scouter2: "Test Scouter Two",
      signature: memberRecord.parentName || "Test Parent",
